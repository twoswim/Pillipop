...
<head>
    <meta charset="utf-8">
    <title>pillipop | boardUpdate</title>
    <!-- SEO Meta Tags-->
    ...
    <main class="page-wrapper">
        ...
        <div class="container pb-lg-5 pb-md-4 pb-2 my-5 writeArea-bw">
            ...
            <div class="row mb-md-2 mb-xl-4">
                <!-- Blog posts-->
                <form action="${path}/board/4_boardUpdate" method="post" enctype="multipart/form-data">
                	<input type="hidden" name="boNo" value="${board.boNo}" />
					<input type="hidden" name="attachment" value="${board.attachment}" />
					<input type="hidden" name="modifiedAttachment" value="${board.modifiedAttachment}" />
					
	                <div class="col-xl-8 pe-lg-4 pe-xl-0" style="margin:0 auto;">
	                    <!-- Writing Title -->
	                    <div class="WritingTitle-bw">
	                        <h3>글쓰기</h3>
	                        <input type="hidden" name="u_no" value="${board.u_no}">
	                        <div class="row1-bw">
	                            <div class="TitleTextArea-bw">
	                                <input placeholder="제목을 입력해 주세요." class="TitleTextArea_input" name="title" value="${board.title}" onfocus="this.placeholder=''" onblur="this.placeholder='제목을 입력해주세요.'" style="overflow: hidden; overflow-wrap: break-word;" required></input>
	                            </div>
	                        </div>
	                        <div class="row2-bw">
	                            ...
	                            <div class="uploadBox-bw">
	                                <input class="uploadName-bw" name="reloadFile" value="첨부파일" placeholder="첨부파일">
	                                <label for="file">파일찾기</label>
	                                <input type="file" id="file" name="reloadFile">
	                    ...
	                    <div class="writeEditor-bw">
	                        <textarea class="summernote" name="boContent" required>${board.boContent}</textarea>
	                    </div>
	                    <!-- writing buttons -->
	                    <div class="writingBtn-bw" style="display : flex; justify-content: space-between;">
	                        ...
	                        <div class="writingBtn-upload">
	                            <button type="submit" class="writing-buttonsEnter">수정완료</button>
	                        </div>
	                    </div>
	                    <script>
