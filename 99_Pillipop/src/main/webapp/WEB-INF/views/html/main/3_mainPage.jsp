        ...
        <section class="ignore-dark-mode position-relative pt-5 ">
            ...
            <div class="container position-relative zindex-2 py-lg-3 pt-5 mt-5 ">
                ...
                <div class="col py-5 mb-md-4 mb-lg-5 ">
                    ...
                    <h1 class="display-3 text-uppercase mb-4 " style="color: white; ">내 의약품 정보는<br>역시 필리팝!</h1>
                    <p class="d-block pb-2 mb-4 mb-md-5 font-NanumL mt-3" style="color: white; font-weight: lighter; font-size: 22px;">
                        이제껏 경험 못 했던 쉽고 풍부한<br>의약 정보 서비스, 필리팝에서 만나보세요.
                    </p>
                </div>
                ...
                <div style="background-image: url(<%=request.getContextPath()%>/resources/img/3_MainPage/Search_bar.png); width: 100%; height: 63px; align-items: center; vertical-align: middle;">
                    ...
                    <div style="height: max-content;">
                        ...
                        justify-content: space-between; align-items: center; width: 91.5%; ">
                            ...
                            <input class="font-NanumB" id="auto" type="text" placeholder="약 이름으로 바로 검색하기" style="align-items: center !important; line-height: 40px; display: inline-block; border: none; background: none; margin-left: 30px; font-weight: 900; width: 80%; ">
                            <button type="button" class="common-black font-NanumB " style=" float: right;" onclick="search()">검색하기</button>
                                ...
                                <script>
	                                ...
	                                $("#auto").autocomplete({
	                                            ...
	                                            success : function(data){ // 성공
	                                                ...
	                                                response(
	                                                    $.map(data.resultList, function(item) {
	                                                        ...
	                                                        return {
	                                                            label : item.ITEMNAME,  // 목록에 표시되는 값
	                                                            value : item.ITEMNAME,  // 선택 시 input창에 표시되는 값
	                                                            index : item.ITEMSEQ	// index
	                                                        };
	                                                    })
	                                                );  
	                                            },
	                                    ...
	                                    select : function(evt, ui) {
	                            			...
	                            			itemSeq = ui.item.index;
// 	                            			window.location = "${path}/medicine/view?itemSeq=" + itemSeq;
	                                    }, 
        ...
        <div  class="bg-position-top-center" style="background-image: url(<%=request.getContextPath()%>/resources/img/3_MainPage/Background1_gra.png); background-repeat: repeat-x;">
            ...
            <p class="pb-3 mb-3 mb-xl-4  font-NanumB text_1-2">약국의 위치와 운영 시간이 궁금하신가요?<br>오늘도 섭취한 그 약, 과연 제대로 알고 계시나요?<br>내 몸에 맞는 영양 성분이 궁금하신가요?<br><br>쉽고 빠르게 여러분의 고민을 해결해 드리겠습니다.<br>건강하고 정확한 데이터를 만나는 최고의 선택!<br>지금 바로 필리팝에서 만나보세요.<br></p>
        ...
        <div style="background-image: url(<%=request.getContextPath()%>/resources/img/3_MainPage/background2.png); position: relative;">
            ...
            <section class="container font-NanumB pb-5 mb-lg-3 mb-xl-4 mb-xxl-5">
                <div class=" pb-4 mb-2 mb-md-3 pt-xxl-5" style="align-items: flex-start; display: flex;">
                    ...
                    <div style="display: inline-block;">
                        ...
                        <!-- View all button-->
                        <div class="" style="z-index: 9; position: relative;"><a class="S_btn3 btn-outline-primary text_1-2 w-100 w-sm-auto" href="${path}/health/Store_main" style="width: 7rem !important;">Store</a>
                        </div>
                    </div>

                </div>
                <div class="" style="display: flex; justify-content: space-between; ">
                    <div class="text_1-2 text-G1 ">어떤 건강식품을 사야할지 고민된다면 인기있는 상품들을 참고해보세요!</div>
                    <div class="">
                    </div>
                </div>
	                            ...
	                            <div class="swiper-slide bg_pink">
	                                ...
	                                <div class="d-flex align-items-center">
										...
										<div class="S_nav_cart ms-auto" data-bs-toggle="tooltip"
											...
											<a class="nav-link fs-lg py-2 px-1" href="#"><i class="ai-cart"></i></a>
										</div>
	                                </div>
	                            </div>
							</c:forEach>
            ...
            <div  class="bg-position-top-center" style="background-image: url(<%=request.getContextPath()%>/resources/img/3_MainPage/background3.png); height: fit-content; background-repeat: repeat;">
                <div class="container pt-5" style="">
                    ...
                    <div class="text_2-5" style="text-align: center; color: white;"><span class="text_2 font-NanumEB"> Pillipop에게
                        ...
                        <ul class="text_1-4 font-NanumR mt_5" style="justify-content: center;">
                            ...
                            <li class="none m_r_8" style="display: inline-block;"><img src="<%=request.getContextPath()%>/resources/img/3_MainPage/check_icon.png">올바른 영양 섭취법</li>
                            <li class="none" style="display: inline-block;"><img src="<%=request.getContextPath()%>/resources/img/3_MainPage/check_icon.png">내일 배송 건강식품 제공</li>
                        </ul>
            ...
            <div class="py-5" style="background-image: url(<%=request.getContextPath()%>/resources/img/3_MainPage/background2.png); position: relative;">
                ...
                <div class="container py-5" style="color: black; ">
                    <div class="left p-sm-5">
                        ...
                        <span class="font-NanumB pb-5" style="display: block; font-size: 29px;">건강에 관련된 흥미로운 <br>정보들을 모아서 볼 수 있어요</span>

                        <button class="news-yellow mt-3 mb-5" style="font-size: 20px;"><a href="${path}/news/newslist" style="text-decoration-line: none; color: inherit;">모든 뉴스 보러 가기</a></button>
                    </div>
                    ...
                    <div class="right mt-3" style="float: right;">
                        <ul class="mt-5">
                                ...
                                <div style=" height: 100%;">
                                    ...
                                    <div class="px-4" style="width: 13rem; position: absolute; ">
                                        <div style="margin-top: 15rem;">
                                            <p class="text-white font-NanumR text_1-4" style="margin-bottom: 5px;">슬기로운 <br>약국 파스 활용법</p>
                                            <p class="text-white font-NanumL text_1-1" style="margin-bottom: 0px;">2020-06-19</p>
                                            <button class="news-button disabled" style="position: absolute; right: 15px;">
                                            <a href="${path}/news/newsdetail?st_seqNo=17" style="color: inherit;">
                                            <i class="ai-chevron-right" style="font-size: 3rem; font-weight: 900; color: inherit;">
                                            </i></a></button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="news-li">
                                <div style=" height: 100%;">
                                    <img src="<%=request.getContextPath()%>/resources/img/3_MainPage/bgimg28.jpg" style="filter: brightness(30%); position: absolute; width: 13.5rem; height: 26rem; object-fit: cover;">
                                    <div class="px-4" style="width: 13rem; position: absolute; ">
                                        <div style="margin-top: 15rem;">
                                            <p class="text-white font-NanumR text_1-4" style="margin-bottom: 5px;">오메가3 <br>합리적으로 선택</p>
                                            <p class="text-white font-NanumL text_1-1" style="margin-bottom: 0px;">2021-02-03</p>
                                            <button class="news-button disabled" style="position: absolute; right: 15px;">
                                            <a href="${path}/news/newsdetail?st_seqNo=25" style="color: inherit;">
                                            <i class="ai-chevron-right" style="font-size: 3rem; font-weight: 900; ">
                                            </i></a></button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li class="news-li">
                                <div style=" height: 100%;">
                                    <img src="<%=request.getContextPath()%>/resources/img/3_MainPage/bgimg10.jpg" style="filter: brightness(30%); position: absolute; width: 13.5rem; height: 26rem; object-fit: cover;">
                                    <div class="px-4" style="width: 13rem; position: absolute; ">
                                        <div style="margin-top: 15rem;">
                                            <p class="text-white font-NanumR text_1-4" style="margin-bottom: 5px;">고관절 <br>강화 운동</p>
                                            <p class="text-white font-NanumL text_1-1" style="margin-bottom: 0px;">2022-07-31</p>
                                            <button class="news-button disabled" style="position: absolute; right: 15px;">
                                            <a href="${path}/news/newsdetail?st_seqNo=8" style="color: inherit;">
                                            <i class="ai-chevron-right" style="font-size: 3rem; font-weight: 900; "></i></a></button>
                                        </div>
                                    </div>
                                </div>
                            </li>
