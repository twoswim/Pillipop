                ...
                <div class="col-lg-6">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="mt-5 pt-lg-3 pb-md-1 pb-lg-3 breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="shop-catalog.html">장바구니</a></li>
                              		...
                              		<div class="align-items-lg-center">
                                   		<div class="g-4 pb-4 pb-md-5 mb-3 mb-md-1  mt-3" style="padding: 0;">
	                                         <div class="col-sm-5 ">
	                                             ...
	                                             <input class="form-control form-control-lg " type="text" placeholder="수령인" required>
	                                         </div>
	                                         ...
	                                         <div class="col-sm-6 mt-3" style="display: inline-block;">
	                                             ...
	                                             <input class="form-control form-control-lg " type="text" id="sample4_detailAddress" name="addr_detail" placeholder="상세주소" required>
	                                         </div>
