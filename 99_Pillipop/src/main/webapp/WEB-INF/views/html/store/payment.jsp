...
<body>
    ...
    <main class="page-wrapper font-NanumR">
        ...
        <form class="needs-validation container position-relative zindex-2 pt-5 pb-lg-5 pb-md-4 pb-2" action="${path}/kakaoPay"  method="post" novalidate>
            <div class="row">
                <div class="col-lg-6">
                    <!-- Breadcrumb-->
                                    ...
                                    <div class="g-4 pb-4 pb-md-5 mb-3 mb-md-1  mt-3" style="padding: 0;">
                                        ...
                                        <div>
                                            ...
                                            <div class="col-sm-5 mt-3 ms-2" style="display: inline-block;">
                                                ...
                                                <input class="form-control form-control-lg" type="tel" id="sample4_jibunAddress" name="addr_land" placeholder="지번주소">
                                            </div>
                                        </div>
                                ...
                                <div class="mt-2 font-NanumB text-dark text_1-1 jus_between">
                                    ...
                                    <div>
										<c:set var="to" value="${total+(basketcount*10000)}"></c:set>
											...
											<input type="hidden" name="pay-name" value="${loginMember.u_name}">
											<input type="hidden" name="pay-tel" value="${loginMember.u_phone}">
											<input type="hidden" name="pay-email" value="${loginMember.u_id}">
											<input type="hidden" id="total-price" value="${to}">
											<input type="hidden" id="total-pay-price" value="${to}">
									</div>
                                </div>
                            </div>
                        </div>
